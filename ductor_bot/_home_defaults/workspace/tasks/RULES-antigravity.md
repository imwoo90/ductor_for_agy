# Background Tasks Directory (DEPRECATED for Gemini/agy)

> [!WARNING]
> This directory and its associated Ductor-level task tools are **DEPRECATED** on this custom branch for Gemini/agy.
